const projectsData = [
  {
    ...
    mainFeatures: [
      ...
      'Advanced filters: property types (mini apartments, shared housing, homestays, etc.), room types (shared/private bathroom, number of bedrooms/living rooms, single room, etc.), price range, and amenities (Wi-Fi, air conditioning, washing machine, etc.)',
    ...
    mainFeaturesVi: [
      ...
      'Bộ lọc nâng cao: loại bất động sản (chung cư mini, nhà ở ghép, homestay, v.v.), loại phòng (phòng tắm chung/riêng, số phòng ngủ/phòng khách, phòng đơn, v.v.), khoảng giá và tiện nghi (Wi-Fi, điều hòa, máy giặt, v.v.)',
  ...
  },
  {
    ...
    mainFeatures: [
      ...
      'Room details and contract management (deposit creation, contract creation, renewal, and cancellation) with tenant check-in and payment confirmation',
      'Handle reports and issues from tenants, with maintenance status updates (pending, in progress, completed)',
      'Monthly statistics on payment status (fully paid, partially paid, unpaid), room status (occupied, vacant, expiring), and maintenance tracking',
    ...
    mainFeaturesVi: [
      ...
      'Chi tiết phòng và quản lý hợp đồng (tạo đặt cọc, tạo hợp đồng, gia hạn và hủy bỏ) với nhận phòng và xác nhận thanh toán',
      'Xử lý báo cáo và sự cố từ người thuê, với cập nhật trạng thái bảo trì (chờ xử lý, đang xử lý, hoàn thành)',
      'Thống kê hàng tháng về tình trạng thanh toán (đã thanh toán, thanh toán một phần, chưa thanh toán), trạng thái phòng (đã thuê, trống, sắp hết hạn) và theo dõi bảo trì',
    ...
    contribution: [
      ...
      'Optimized codebase and project structure, refactored legacy code, and improved performance and state management',
    ...
    contributionVi: [
      ...
      'Tối ưu hóa codebase và cấu trúc dự án, tái cấu trúc mã cũ, và cải thiện hiệu suất và quản lý trạng thái',
  ...
  },
  {
    ...
    contribution: [
      ...
      'Optimized and refactored the codebase. Cleaned up legacy code, applied best practices for state management, and improved responsiveness.',
      'Updated the UI in collaboration with the Designer',
      'Managed tasks: assigned and received tasks, updated statistics for assigned tasks and directed tasks.'
    ],
    contributionVi: [
      'Đóng góp ước tính 16% dự án',
      'Tối ưu hóa và tái cấu trúc mã. Dọn dẹp mã nguồn cũ, áp dụng các phương pháp quản lý trạng thái tốt nhất và nâng cao khả năng phản hồi.',
      'Cập nhật lại giao diện, phối hợp cùng Designer',
      'Quản lý nhiệm vụ, giao và nhận nhiệm vụ, cập nhật thống kê nhiệm vụ được giao, nhiêm vụ chỉ đạo.'
    ],
  ...
  },
  {
    ...
    mainFeatures: [
      ...
      'Platform for showcasing trusted products and services, acting as an e-commerce bridge connecting manufacturers, distributors, and exporters to end consumers in compliance with regulations'
    ],
    mainFeaturesVi: [
      ...
      'Nền tảng giới thiệu sản phẩm và dịch vụ uy tín, đóng vai trò cầu nối thương mại điện tử kết nối nhà sản xuất, nhà phân phối và nhà xuất khẩu với người tiêu dùng theo quy định'
    ],
    contribution: [
      'Key contributor (~50% of the project)',
      'Refactored and structured the codebase, applied best practices in state management, and organized the project using corebase and melos',
    ...
    contributionVi: [
      ...
      'Tái cấu trúc và tổ chức codebase, áp dụng best practices trong quản lý trạng thái, và tổ chức dự án sử dụng corebase và melos',
  ...
  },
  {
    ...
    mainFeatures: [
      'Manage devices, including quantity, status (RAM, ROM, CPU, temperature), operational state (online/offline), and location',
    ...
    mainFeaturesVi: [
      'Quản lý thiết bị, bao gồm số lượng, trạng thái (RAM, ROM, CPU, nhiệt độ), trạng thái hoạt động (online/offline) và vị trí',
  ...
  },
  {
    ...
    mainFeatures: [
      ...
      'Track attendance with detailed daily records by month, including working days, working hours, and statuses (late arrival, early leave, on time, absent)',
    ...
    mainFeaturesVi: [
      ...
      'Theo dõi chấm công với bản ghi chi tiết hàng ngày theo tháng, bao gồm ngày làm việc, giờ làm việc và trạng thái (đi muộn, về sớm, đúng giờ, vắng mặt)',
